...
export TAU_MAKEFILE=/work/02463/srinathv/maverick/tau2/x86_64/lib/Makefile.tau-intel15-icpc-papi-ompt-openmp-profile-trace
...
make clean
make psum_openmp VERBOSE=1 2>&1 | tee build.out
